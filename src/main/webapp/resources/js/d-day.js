...
function timer_start1() {
    ...
    myTimer = setInterval(function() {
        ...
        if (--time < 0) {
			...
			var div = document.createElement('div');
			div.id = "time_end2";
   			document.getElementById("timebox1").after(div);
			document.getElementById("time_end2").innerHTML="<div class='time_end_box'>SALE END</div>";
		}
        document.getElementById('timebox1').innerHTML = convertTime();
    }, 100);
}
