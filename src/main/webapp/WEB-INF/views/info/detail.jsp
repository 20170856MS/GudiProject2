...
<link href="/resources/css/resetInfo.css" rel="stylesheet"
	type="text/css">
<link href="/resources/css/infoDetail.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<div class="top">
		<div class="card bg-dark text-white detailName">
			<img src="https://janet.co.kr/data/licenseitem/155/7JiB7Ja0.jpg"
				class="card-img" alt="...">
			<div class="card-img-overlay">
				<h1 class="card-title">정보처리기사</h1>
			</div>
		</div>
	</div>
