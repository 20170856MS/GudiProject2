	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<header id="header">
			<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"
				...
				<div class="container">
					<a class="navbar-brand d-inline-flex" href="/"><img class="d-inline-block"
							src="/resources/img/team_logo123.png" alt="logo" width="190px" /></a>
							...
							<c:choose>
										...
										<c:when test="${check.adminRoleDTOs[0].roleName == 'admin'}">
											<div class="text-end">
												...
												<a href="/member/myPage"
													class="btn btn-white shadow-warning text-primary myPage">마이페이지</a>
												<a href="/member/logout"
													class="btn btn-white shadow-warning text-primary logout">로그아웃</a>
											</div>
								...
								<c:when test="${sessionConfigVO ne null}">
									<ul style="height:30px;float:right;margin-bottom:20px;" class="fn-font">
										<li><a style="color:#f97088;text-decoration:none;"
												class="">${sessionConfigVO.userName}' s come in</a></li>
								...
								<c:when test="${sessionConfigVO1 ne null}">
									<ul style="height:30px;float:right;margin-bottom:20px;" class="fn-font">
										<li><a style="color:#f97088;text-decoration:none;"
												class="">${sessionConfigVO1.userName}' s come in</a></li>
								...
								<c:otherwise>
									<div class="text-end">
										<a href="/member/login"
											class="btn btn-white shadow-warning text-primary login">로그인</a>
									</div>
								</c:otherwise>
							</c:choose>
						</form>
								...
								<nav class="gnb_menu">
									<ul id="skip_gnb" class="gnb">
										...
										<li><a href="#" title="커뮤니티">커뮤니티</a>
											<div class="dep2" style="height: 0px;">
												<ul class="depth2" style="display: none;">
													<li><a href="/qna/list" title="Q&A">게시판</a></li>
										...
										<li><a href="#" title="${check.adminRoleDTOs[0].roleName}">관리자 페이지</a>
											<div class="dep2" style="height: 0px;">
												<ul class="depth2" style="display: none;">
													...
													<li><a href="/admin/modal_adminDetail" title="test1">매장 정보 수정</a>
													</li>
										...
										<li><a href="#" title="TEST6">StudyCafe</a>
											<div class="dep2" style="height: 0px;">
												<ul class="depth2" style="display: none;">
													...
													<li><a href="/studyCafe/reList" title="test1">reList</a></li>
