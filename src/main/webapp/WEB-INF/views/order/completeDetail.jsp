            ...
            <div class="checkout-form">
                                        ...
                                        <table class="point_table">
                                            <tr>
                                                ...
                                                <th scope="col">시간</th>
                                                    ...
                                                    <tr>	
														<input type="hidden" value="${orderDTO.detailNum}">
                ...
                <div class="row text-center">
                    <div class="col-lg-12" style="width: 100%;">
                        ...
                        margin-bottom: 48px;
                    ">
                            <button type="submit" class="site-btn place-btn" id="dateAdmin" onclick="location.href='/studyCafe/reUpdate?detailNum=${orderDTO.detailNum}'" style="padding-top: 3px; padding-bottom: 3px;">예약 변경하기</button>
